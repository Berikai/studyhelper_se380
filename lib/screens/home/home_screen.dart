        ...
        return Scaffold(
          ...
          body: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                const Text('Welcome back, Student!', style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold, color: Colors.white)),
                const SizedBox(height: 8),
                const Text('Here is your study overview for today.', style: TextStyle(fontSize: 14, color: Colors.grey)),
                ...
                GridView.count(
                  ...
                  children: [
                    ...
                    _buildStatCard('Mastery', 'In Progress', Icons.stars, Colors.pinkAccent),
                  ],
                ),
                
                const SizedBox(height: 24),
                const Text('Most Studied Lecture', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Colors.white)),
                      ...
                      children: [
                        ...
                        Expanded(
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Text(mostStudiedLecture.title, style: const TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: Colors.white)),
                              const SizedBox(height: 4),
                              Text('${mostStudiedLecture.questions} flashcards generated', style: const TextStyle(fontSize: 12, color: Colors.grey)),
                            ],
                          ),
                        ),
                      ],
                ...
                const SizedBox(height: 24),
                const Text('AI Study Suggestions', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Colors.white)),
                const SizedBox(height: 12),
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        const SizedBox(height: 12),
                        Text('You should focus on "${leastStudiedLecture.title}". It currently has the least amount of flashcards (${leastStudiedLecture.questions}). Generate more flashcards to improve mastery!', style: const TextStyle(color: Colors.white)),
